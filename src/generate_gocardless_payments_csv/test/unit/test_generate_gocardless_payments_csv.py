    ...
    expected_payments_df = pandas.DataFrame([
        {
            ...
            "payment.charge_date": "2021-02-03",
            "payment.currency": "GBP",
            "payment.description": "INV123/ID123",
    ...
    invoice_df = pandas.DataFrame([
        {
            ...
            "gocardless_email": "",
            "invoice_date": "",
            "item_lines.0.amount": "1.00",
            "item_lines.1.amount": "2.00",
            "payments.0.amount": "3.00",
            "parent_email": "Email parent",
            "parent_id": "ID123",
            "payment_method": "",
        },
